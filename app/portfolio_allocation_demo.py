            ...
            writer.writerow(
                {
                    ...
                    "economic_copyability_source": row.get("economic_copyability_source", ""),
                    ...
                    "economic_copyability_executable_with_roundup": row.get(
                        "economic_copyability_executable_with_roundup",
                        "",
                    ),
                    "economic_copyability_executable_after_batch": row.get(
                        "economic_copyability_executable_after_batch",
                        "",
                    ),
                    "economic_copyability_dust_signals": row.get(
                        "economic_copyability_dust_signals",
                        "",
                    ),
                    "economic_copyability_requirement_samples_json": row.get(
                        "economic_copyability_requirement_samples_json",
                        "",
                    ),
